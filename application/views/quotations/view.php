    ...
    <div class="card-body">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <div class="text-muted"><i class="bi bi-telephone me-1"></i><?= htmlspecialchars($quote->customer_phone) ?></div>
                <?php endif; ?>
                <?php if ($quote->customer_email): ?>
                <div class="text-muted"><i class="bi bi-envelope me-1"></i><?= htmlspecialchars($quote->customer_email) ?></div>
                <?php endif; ?>
            </div>
