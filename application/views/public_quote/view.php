...
<head>
    ...
    <style>
        ...
        .share-bar .quote-ref { font-size: .8rem; color: #6c757d; margin-right: auto; }
        .btn-wa {
...
$wa_text     = urlencode(
    'Hi, please find your quotation ' . $quote->quote_number .
    ' from ' . ($quote->company_name ?: 'us') .
    ' here: ' . $page_url
);
...
function copyLink(btn) {
    var url = '<?= addslashes(current_url()) ?>';
